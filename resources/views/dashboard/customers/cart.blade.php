        ...
        <div class="row" style="margin-top: 30px;">
            <div class="col-lg-9 col-md-9 col-sm-7 col-xs-6 col-xxs-12 text-center-xs">
                <h2 class="section-title-inner">
                    <span><i class="glyphicon glyphicon-shopping-cart"></i> Your Shopping cart </span>
                </h2>
            </div>
                                ...
                                <tr class="CartProduct">
                                    ...
                                    <td>
                                        <div class="CartDescription">
                                            ...
                                            <span class="size">12 x 1.5 L</span>
                                            <div class="price"><span>GH₵30</span></div>
                                        </div>
                                    </td>
                                    <td class="delete"><a title="Delete"> <i class="glyphicon glyphicon-trash fa-2x"></i></a></td>
                                    <td><input class="quanitySniper" type="text" value="2" name="quanitySniper"></td>
                                    <td>0</td>
                                    <td class="price">GH₵60</td>
                                </tr>
                                <tr class="CartProduct">
                                    <td class="CartProductThumb">
                                        <div>
                        ...
                        <div class="table-block" id="order-detail-content">
                            ...
                            <div class="w100 cartMiniTable">
                                <table id="cart-summary" class="std table">
                                    ...
                                    <tr>
                                        <td>Total tax</td>
                                        <td class="price" id="total-tax">GH₵0.00</td>
                                    </tr>
                                    <tr>
                                        <td> Total</td>
                                        <td class=" site-color" id="total-price">GH₵216.51</td>
                                    </tr>
                                    {{--<tr>
                                        <td colspan="2">
